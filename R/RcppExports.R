...
testing_01 <- function(X, V) {
    invisible(.Call(`_coda_base_testing_01`, X, V))
}

testing_02 <- function() {
    invisible(.Call(`_coda_base_testing_02`))
}

testing_03 <- function() {
    invisible(.Call(`_coda_base_testing_03`))
}

testing_04 <- function(X) {
    .Call(`_coda_base_testing_04`, X)
}

testing_05 <- function(X) {
    .Call(`_coda_base_testing_05`, X)
}

testing_06 <- function(X) {
    .Call(`_coda_base_testing_06`, X)
}

find_predictive_balance <- function(Y, x, method = 1L) {
    .Call(`_coda_base_find_predictive_balance`, Y, x, method)
}
...
find_principal_balance_01 <- function(X) {
    .Call(`_coda_base_find_principal_balance_01`, X)
}

find_principal_balance_02 <- function(X) {
    .Call(`_coda_base_find_principal_balance_02`, X)
}

find_principal_balance2_01 <- function(X) {
    .Call(`_coda_base_find_principal_balance2_01`, X)
}

find_principal_balance3_01 <- function(X) {
    .Call(`_coda_base_find_principal_balance3_01`, X)
}
